...
def main_app():
    ...
    # 2. Spelarstatistik (Tränarvy med direkt tillagd spelare-funktion)
        ...
        with col_a:
            ...
            with st.form("update_player_form"):
                ...
                new_time = st.number_input("Tid med boll (s)", value=50)
                new_actions = st.number_input("Framåtdrivande aktioner", value=10)
        ...
        # Lägg till helt ny spelare direkt i appen
        with col_b:
            st.subheader("Lägg till ny spelare")
            with st.form("add_player_form"):
                new_name = st.text_input("Spelarens fullständiga namn")
                init_time = st.number_input("Startvärde: Tid med boll (s)", value=40)
                init_actions = st.number_input("Startvärde: Framåtdrivande aktioner", value=5)
                init_eff = st.number_input("Startvärde: Slot-effektivitet (%)", value=25.0)
